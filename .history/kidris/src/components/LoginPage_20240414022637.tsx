      ...
      <div className="app-login flex justify-center items-center mt-5">
        <form action="" className="mt-2 flex flex-col lg:w-1/2 w-8/12">
          <div className="flex flex-wrap w-full relative h-15 bg-white items-center rounded mb-6 pr-10">
            ...
            <input
              type="text"
              className="flex-shrink flex-grow leading-normal w-px flex-1 border-0 h-10 border-grey-light rounded rounded-l-none px-3 self-center relative font-roboto text-xl outline-none text-left"
          ...
          <div className="flex flex-wrap w-full relative h-15 bg-white items-center rounded mb-4">
            ...
            <input
              type="password"
              className="flex-shrink flex-grow leading-normal w-px flex-1 border-0 h-10 px-3 relative self-center font-roboto text-xl outline-none text-left"
